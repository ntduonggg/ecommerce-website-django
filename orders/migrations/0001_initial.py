    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adddess_line1', models.CharField(max_length=100)),
                ('adddess_line2', models.CharField(blank=True, max_length=100)),
                ('province', models.EmailField(max_length=100, unique=True)),
                ('village', models.CharField(blank=True, max_length=100)),
                ('order_total', models.FloatField()),
                ('tax', models.FloatField()),
                ('discount', models.FloatField()),
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accepted'), ('Delivering', 'Delivering'), ('Completed', 'Completed'), ('Cancelled', 'Cancelled')], default='New', max_length=15)),
